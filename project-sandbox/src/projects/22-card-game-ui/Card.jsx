...
function Card({ player, defenseValue, attackValue, unitTypeName, unitTypeImg, moralValue, unitValue }) {
    let iconStyle = {
        marginRight: 10,
        width: 20,
    ...
    return (
        <div className={`card text-center m-1 shadow-lg ${player === "player_1" ? "card-info" : "card-danger"}`} style={{ "width": "180px" }}>
